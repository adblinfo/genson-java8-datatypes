...
public class MonthDayConverter implements Converter<MonthDay> {
	...
	@Override
	public void serialize(MonthDay object, ObjectWriter writer, Context ctx) throws Exception {
	...
	@Override
	public MonthDay deserialize(ObjectReader reader, Context ctx) throws Exception {
		if (ValueType.NULL.equals(reader.getValueType())) {
			return null;
		}
		return MonthDay.parse(reader.valueAsString());
	}
